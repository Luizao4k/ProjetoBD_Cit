...
este arquivo só sabe "qual URL/verbo HTTP aponta pra qual função"; a
lógica do handler mora em controllers/importacao_controller.py.
"""
...
importacao_bp.add_url_rule(
    "", view_func=importacao_controller.importar_dados, methods=["POST"]
)
