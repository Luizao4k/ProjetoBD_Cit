"""
Modulo contendo a entidade web_escola, validações e o comportamento.
"""
...
class WebEscola:
    """
    Representa uma web escola cadastrada no sistema
    """
    escola_id: int              #OBRIGATORIO
    ip: str                     #OBRIGATORIO
    id_web_escola: Optional[int] = None    #OPCIONAL
    ...
    def _validar_escola_id(self):
        if not isinstance(self.escola_id, int): # type: ignore
            raise TypeError("escola_id deve ser um inteiro ")
