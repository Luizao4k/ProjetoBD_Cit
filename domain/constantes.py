...
MUNICIPIOS_VALIDOS: Final[list] = {
    ...
    "Peixe-Boi", "Piçarra", "Placas", "Ponta de Pedras", "Portel",
    "Porto de Moz", "Prainha", "Primavera", "Quatipuru", "Redenção",
    "Rio Maria", "Rondon do Pará", "Rurópolis", "Salvaterra",
    ...
    "Tracuateua", "Trairão", "Tucumã", "Tucuruí", "Ulianópolis",
